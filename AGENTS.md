...
- Use `gpt-5.4-nano` in every live-test command, fixture intended for live use, and development example that could incur model cost. Other model names may appear only when documenting generic client input or protocol history.
