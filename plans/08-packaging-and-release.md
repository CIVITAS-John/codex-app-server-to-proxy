...
- The opt-in live smoke must be explicitly authorized, use only `gpt-5.4-mini`, state the expected normal count and hard maximum of seven model calls on POSIX before execution, and record the exact count afterward.
