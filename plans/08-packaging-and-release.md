...
| Opt-in `gpt-6-luna` live smoke with exact provider-response record | Blocked on Codex model-cache metadata; 0 provider responses used on 2026-09-22 |
