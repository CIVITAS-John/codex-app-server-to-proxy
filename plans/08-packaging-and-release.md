...
- The opt-in live smoke must be explicitly authorized, use only `gpt-5.4-mini`, state the expected normal count of seven and hard maximum of eight model calls on POSIX before execution, and record the exact count afterward.
