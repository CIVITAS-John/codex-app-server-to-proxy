...
| `turn/start` | Starts one turn on a non-busy thread and explicitly reapplies cwd, approval settings, and the full sandbox policy so sticky prior-turn state is never inherited accidentally. |
